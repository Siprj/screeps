...
type StoreDefinition = Partial<Record<_ResourceConstantSansEnergy, number>> & { 
    ...
    * total capacity if resource is `undefined`.
    ...
    * A shorthand for:
    * ```
    * getCapacity(resource) - getUsedCapacity(resource).
    * ```
    * @param resource Type of the resource.
    */
...
interface StructureSpawn extends OwnedStructure<STRUCTURE_SPAWN> {
    ...
    /**
     * @deprecated This method is deprecated and will be removed soon. Please use `store.[RESOURCE_ENERGY]`
     * The amount of energy containing in the spawn.
     */
    energy: number;
    /**
     * @deprecated This method is deprecated and will be removed soon. Please use `store.getCapacity[RESOURCE_ENERGY]`
